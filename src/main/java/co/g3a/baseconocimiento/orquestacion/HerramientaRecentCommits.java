 ...
 *
 * <p>Consulta {@code documents} de fuentes {@code local_git}, no invoca Git en
 * vivo: el conector que puebla esas filas es F6. Hasta entonces esta
 * herramienta devuelve una lista vacía — el comportamiento correcto para un
 * conector deshabilitado, no un error.
 */
@Component
