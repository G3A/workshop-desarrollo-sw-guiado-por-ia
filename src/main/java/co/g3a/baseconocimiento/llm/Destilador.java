...
/**
 * Destila contenido conversacional ruidoso — un hilo de Teams — en campos
 * estructurados antes de indexarlo: la pieza que el artículo de Cerebras
 * señala como decisiva. {@code ingesta.package-info} explica por qué esto NO
 * aplica a documentos ni código ya estructurados (esos se "destilan"
 * heurísticamente, sin LLM).
 *
 * <p>Igual que {@link Planificador} y {@link Sintetizador}: recibe texto
 * plano, sin saber qué es un hilo de Teams ni un chunk.
 */
