/**
 * Acceso al modelo de generacion: OpenAI contra llama-server (Bonsai 8B, ver
 * ADR-0009) para el planificador, el verificador de grounding y el
 * sintetizador; Ollama para el destilador de Teams (F6), que se quedo ahi.
 *
