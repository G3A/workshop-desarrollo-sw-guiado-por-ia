...
| `spring-boot-starter-actuator` está en el classpath pero no hay evidencia de que esté expuesto o consumido. | usuario | alta | confirmada (queda como TODO explícito en `infrastructure.md`) |
