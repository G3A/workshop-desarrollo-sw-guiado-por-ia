...
/**
 * Prueba de humo del cross-encoder real: carga el ONNX y el tokenizador que
 * {@code make pull-models} descarga, y verifica que distingue un pasaje
 * relevante de uno irrelevante.
 *
 * <p>Se salta sola si los archivos no están (máquinas de desarrollo que aún no
 * corrieron {@code make pull-models}) — no es un test que deba bloquear a
 * quien recién clona el repo.
 */
class RerankerOnnxTest {
    ...
    void distingueUnPasajeRelevanteDeUnoIrrelevante() {
        ...
        String pasajeRelevante = "Para desplegar el servicio corre docker compose up y luego make pull-models.";
