...
class FusionDeHerramientasTest {
  ...
  void deduplicaPorIdConElMejorPuntaje() {
    ...
    List<Fragmento> combinado =
        FusionDeHerramientas.combinar(List.of(List.of(debil), List.of(fuerte)), 10);
  ...
  void respetaElTope() {
    List<Fragmento> muchos =
        List.of(fragmento(1, 0.9, null), fragmento(2, 0.8, null), fragmento(3, 0.7, null));
