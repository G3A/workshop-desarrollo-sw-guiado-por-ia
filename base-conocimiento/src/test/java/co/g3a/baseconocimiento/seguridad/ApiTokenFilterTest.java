...
/**
 * {@link ApiTokenFilter} sin contexto de Spring: es un filtro de servlet puro, no hace falta
 * Postgres ni Ollama para verificar su contrato.
 */
class ApiTokenFilterTest {
  ...
  @Test
  @DisplayName(
      "Con token configurado, /api/messages queda excluido: el Bot Connector valida su propio JWT")
  ...
  @Test
  @DisplayName(
      "Con token configurado, /api/admin/ayuda queda excluido: el boton ? tambien vive en el chat")
  ...
  @Test
  @DisplayName(
      "Con token configurado, /api/admin/proyectos queda excluido: el selector tambien vive en el chat")
  ...
  @Test
  @DisplayName(
      "Con token configurado, /api/vault/contenido queda excluido: el visor de citas tambien vive en el chat")
