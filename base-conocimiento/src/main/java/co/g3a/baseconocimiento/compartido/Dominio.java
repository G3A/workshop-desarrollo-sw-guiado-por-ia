 ...
 *
 * <p>Se agrupa en un solo archivo porque son records sin comportamiento: separarlos en ocho
 * archivos daria ocho lugares donde mirar para entender una sola idea.
 */
public final class Dominio {
   ...
   *     restricción (todo el corpus del proyecto). Es el filtro "activar/desactivar documentos por
   *     conversación" de la UI web.
   */
  public record Filtros(
      List<String> fuentes, Instant desde, int maxCandidatos, List<Long> documentosPermitidos) {
   ...
   *
   * @param ord posicion del chunk dentro de su documento; la usa la expansion de contexto de F3
   *     para pedir las secciones vecinas
   ...
   *
   * @param advertencias evidencia contradictoria o desactualizada que el sintetizador debe declarar
   *     en vez de dar falsa certeza
   * @param consultaReformulada la consulta que de verdad se usó para buscar, si el {@code
   *     Reformulador} la cambió; {@code null} si buscó con la pregunta tal cual (caso normal)
   */
