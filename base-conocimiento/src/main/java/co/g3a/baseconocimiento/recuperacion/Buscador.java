...
public interface Buscador {
  ...
  /**
   * Las cuatro señales sobre el corpus del proyecto. Solo considera chunks cuyo {@code kind} esté
   * en {@code tiposPermitidos} y cuyo documento esté en {@code documentosPermitidos}; una lista
   * vacía en cualquiera de los dos equivale a no filtrar por ese eje.
   */
  ...
  /**
   * Solo la señal 1 (texto completo): sin embedding, sin IDF, sin decaimiento ni cross-encoder.
   * Existe para el adaptador web de F4 — el "keyword search on landing" del artículo: algo que
   * responde casi al instante mientras el pipeline completo de siete etapas todavía está corriendo
   * detrás.
   */
