 ...
 * alimenta la señal 3 (supresión de relleno por IDF) sin tocarla en cada búsqueda.
 *
 * <p>Deshabilitable con {@code kb.recuperacion.terminos.habilitado=false}, igual que el worker de
 * ingesta: pruebas que no necesitan este barrido de fondo lo apagan.
 */
@Component
@ConditionalOnProperty(
    prefix = "kb.recuperacion.terminos",
    name = "habilitado",
    matchIfMissing = true)
