...
/**
 * Expone el retrieval híbrido de F2 por su propia cuenta, antes de que exista
 * el planner de F3. Vive dentro de {@code recuperacion}, no en {@code web}:
 * es un endpoint de esta etapa sobre sí misma, igual que
 * {@code IngestaController} dentro de {@code ingesta} — la regla de ArchUnit
 * que aísla a los adaptadores no aplica a estos controllers operativos.
 */
@RestController
