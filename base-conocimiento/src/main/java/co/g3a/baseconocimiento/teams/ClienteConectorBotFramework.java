...
/**
 * Sale hacia el Bot Connector API: token de aplicación por {@code client_credentials} (cacheado
 * hasta cerca de su vencimiento), indicador de escritura y la respuesta final como Adaptive Card,
 * ambos vía {@code POST {serviceUrl}/v3/conversations/{id}/activities/{id}} (la operación {@code
 * Conversations_ReplyToActivity} del Connector API).
 *
 * <p>Sin {@code kb.teams.app-id}/{@code app-password} configurados, sale sin token: así funciona
 * igual contra el Bot Framework Emulator sin credenciales, el modo de prueba más común.
 */
@Component
