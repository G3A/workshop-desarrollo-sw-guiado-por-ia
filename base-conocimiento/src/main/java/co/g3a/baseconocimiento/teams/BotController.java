...
/**
 * {@code POST /api/messages}: el único endpoint que Azure Bot Service (o el Bot Framework Emulator)
 * llama. Devuelve 200 de inmediato — la respuesta de verdad viaja por su cuenta al Connector API
 * vía {@link ProcesadorDeMensajes}, porque la síntesis tarda minutos en CPU (ver Riesgos vivos del
 * plan) y el webhook no puede esperarla.
 *
 * <p>Deshabilitado por defecto ({@code kb.teams.habilitado=false}): el producto se demuestra
 * completo sin este adaptador.
 */
@RestController
