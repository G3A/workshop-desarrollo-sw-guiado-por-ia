...
/**
 * Un {@code JsonMapper} propio de este módulo, igual que {@code ingesta} y {@code orquestacion}:
 * cada módulo con el suyo en vez de compartir uno desde {@code compartido}.
 */
final class Json {
