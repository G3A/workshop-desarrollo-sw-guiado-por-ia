...
/**
 * Propone, si hace falta, una consulta de búsqueda alternativa que use el vocabulario y el idioma
...
public interface Reformulador {
  ...
  /**
   * @param textoBusqueda la consulta a usar contra las herramientas de búsqueda — igual a la
   *     pregunta original si {@code reformulada} es {@code false}
   * @param reformulada {@code true} solo si de verdad cambió el texto, para que el llamador no
   *     tenga que comparar strings para saber si mostrarlo
   */
