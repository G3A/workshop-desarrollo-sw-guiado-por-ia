...
/**
 * Encuentra qué documentos son la autoridad sobre un tema: la búsqueda
 * híbrida, agrupada por documento y quedándose con el mejor fragmento de cada
 * uno.
 *
 * <p>Es una aproximación honesta a lo que el nombre promete. El artículo de
 * Cerebras responde "quién sabe de esto" con participantes reales de Slack;
 * aquí, hasta que existan los conectores de Teams y Git (F6) con metadatos de
 * autoría, la mejor respuesta disponible es "qué documento cubre esto mejor" —
 * no un invento de una persona que el sistema no puede verificar.
 */
@Component
