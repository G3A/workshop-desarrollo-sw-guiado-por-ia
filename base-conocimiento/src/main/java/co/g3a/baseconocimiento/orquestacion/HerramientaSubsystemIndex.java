...
/**
 * Un índice de qué subsistemas cubre el corpus, agregando {@code distilled.systems_mentioned}.
 *
 * <p>Ese campo lo puebla la destilación por LLM de hilos de Teams (F6); para documentos y código de
 * hoy, cuya "destilación" es heurística (ver {@code package-info} de {@code ingesta}), esta
 * herramienta devuelve vacío — no hay nada que agregar todavía, y eso es honesto, no un error.
 */
@Component
