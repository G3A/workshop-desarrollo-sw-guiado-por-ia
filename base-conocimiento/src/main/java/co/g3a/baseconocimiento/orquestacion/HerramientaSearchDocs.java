...
/**
 * La misma búsqueda híbrida, pero restringida a documentación y wiki — nunca código ni hilos. Útil
 * cuando la pregunta es claramente sobre "qué dice la documentación", donde mezclar con código solo
 * añade ruido.
 */
@Component
