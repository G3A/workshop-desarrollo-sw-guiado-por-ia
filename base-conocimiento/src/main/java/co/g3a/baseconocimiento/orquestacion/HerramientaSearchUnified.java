...
/**
 * La búsqueda híbrida de F2 completa, sin restringir por tipo de chunk: las cuatro señales, RRF y
 * el cross-encoder. La opción por defecto cuando el planner duda.
 */
@Component
