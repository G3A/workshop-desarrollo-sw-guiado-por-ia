...
/** Convierte un {@link Fragmento} a la {@link Cita} que ve el usuario final. Usado por {@code Orquestador} y {@code Consultador}. */
final class Citas {
    ...
    static Cita desde(Fragmento f) {
        ...
        String extracto = texto.length() > LONGITUD_EXTRACTO
