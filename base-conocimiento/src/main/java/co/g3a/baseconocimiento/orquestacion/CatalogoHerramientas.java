...
/**
 * El registro de las seis herramientas, indexado por nombre. Spring inyecta
 * automáticamente todos los beans {@link Herramienta} en la lista del
 * constructor — agregar una séptima herramienta es escribir la clase y
 * anotarla {@code @Component}, nada más.
 */
@Component
