 ...
 *
 * <p>Ancla siempre en lo que la ingesta destiló, nunca en el texto crudo — ver {@code
 * V1__esquema.sql} y el comentario de {@code chunks.embedding}.
 */
public interface Embeddings {
   ...
   *
   * @throws IllegalStateException si el modelo configurado no produce vectores de {@link
