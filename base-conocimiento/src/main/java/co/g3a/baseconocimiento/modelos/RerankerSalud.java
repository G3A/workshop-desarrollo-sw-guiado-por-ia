 ...
 *
 * <p>Cargar el modelo (~550 MB) en cada chequeo de salud seria absurdo; esto solo
 * mira el disco. El primer {@code puntuar()} real es quien paga la carga, una
 * sola vez, con el candado en {@link RerankerOnnx}.
 */
@Component("reranker")
