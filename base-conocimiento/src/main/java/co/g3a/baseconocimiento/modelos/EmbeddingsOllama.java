...
/**
 * Adaptador sobre {@link EmbeddingModel} de Spring AI, servido por Ollama
 * ({@code bge-m3}).
 *
 * <p>Es la única clase del núcleo que conoce el tipo de Spring AI para
 * embeddings: el resto depende solo de {@link Embeddings}.
 */
@Component
