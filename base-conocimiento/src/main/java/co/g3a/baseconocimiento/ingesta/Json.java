 ...
 *
 * <p>OJO: Spring Boot 4 trae Jackson 3 ({@code tools.jackson.databind}), no Jackson 2 ({@code
 * com.fasterxml.jackson.databind}). Los nombres de paquete cambiaron y {@link
 * tools.jackson.core.JacksonException} ahora es una excepción de tiempo de ejecución, no una {@code
 * IOException} — por eso las llamadas de abajo no piden {@code try/catch}.
 */
final class Json {
