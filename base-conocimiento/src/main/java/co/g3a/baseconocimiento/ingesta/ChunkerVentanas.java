...
/**
 * Trocea texto plano por párrafos, agrupándolos en ventanas de hasta
 * {@code maxCaracteres}.
 *
 * <p>Es el respaldo para lo que no trae una estructura reconocible: el texto
 * que sale de un PDF no conserva encabezados fiables, así que no hay con qué
 * alimentar a {@link ChunkerEncabezados}. Documentado como limitación
 * heurística, no como una decisión de diseño — ver el ADR correspondiente.
 */
