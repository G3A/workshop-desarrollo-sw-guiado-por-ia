...
class ChatController {
  ...
  List<Cita> previsualizar(@Valid @RequestBody PreguntaWeb pregunta) {
    return consultar.previsualizar(
        ...
        ParametrosWeb.proyectoDe(pregunta.projectId()),
        previewLimite,
        ParametrosWeb.documentosDe(pregunta.documentos()));
  }
  ...
  Flux<ServerSentEvent<Object>> chat(
    ...
    Filtros filtros = Filtros.conDocumentos(ParametrosWeb.documentosDe(documentos));
    Consultar.RespuestaEnStreaming resultado =
        consultar.responderEnStreaming(
            new Pregunta(q),
            ParametrosWeb.proyectoDe(projectId),
            filtros,
            conversacionId,
            ...
            error ->
                Flux.just(
                    ServerSentEvent.builder()
                        ...
                        .<Object>data(Json.escribir(MensajesDeError.mensajeDe(error)))
                        .build()));
  }
